...
def batch_gd(model, criterion, optimizer, train_loader, val_loader, epochs: int, name: str) -> tuple[list, list]:
    ...
    for iter in tqdm(range(epochs)):
        ...
        dt = datetime.now() - t0
        print(f'Epoch {iter + 1}/{epochs}, Train Loss: {train_loss:.4f}, \
